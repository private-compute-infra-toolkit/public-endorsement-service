...
def pes_aws_eif_and_ami(
        ...
        service_name = "pes",
        **kwargs):
    """Generates a PES-specific AWS EIF and AMI with standard defaults.
    ...
    Args:
        ...
        jar_args: The arguments to pass to the service JAR. Defaults to local TLedger URL.
        extra_container_tars: Extra container layer tars to package into the EIF.
        extra_jvm_options: Extra JVM options to append to standard PES defaults.
        ...
        jar_path: Label of the target JAR binary. Defaults to "//java/com/google/pes/server:server_main_deploy.jar".
        service_name: The name of the systemd service. Defaults to "pes".
